    ...
    def main(self):
        ...
        while not rospy.is_shutdown():
            ...
            if first == False:
                ...
                distance_left = ((left_tick - self.pre_l_tick) / encoder_counts_per_rev) * wheel_circum
                distance_right = ((right_tick - self.pre_r_tick) /encoder_counts_per_rev) * wheel_circum
            ...
            self.pre_l_tick = left_tick
            self.pre_r_tick = right_tick
            if left_tick != 0 or right_tick != 0:
                first = False
            r.sleep()
